...
import Example_3_7 from "./components/3-7-DeclarativeRendering.vue";
import Example_3_8 from "./components/3-8-ReactiveVariable.vue";
...
<template>
  ...
  <!-- <Example_3_7 msg="3-7-DeclarativeRendering.vue" /> -->
